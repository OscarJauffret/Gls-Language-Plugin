...
public class GillesParserDefinition implements ParserDefinition {
    public static final IFileElementType FILE = new IFileElementType(GillesLanguage.INSTANCE);
    /**
     ...
     * (for example {@link JavaDocElementType#DOC_COMMENT}).
     *
    ...
    public @NotNull TokenSet getStringLiteralElements() {
        return GillesTokenSets.LITERALS;
    }
    ...
    public @NotNull PsiElement createElement(ASTNode node) {
        return GillesTypes.Factory.createElement(node);
    }
    ...
    public @NotNull PsiFile createFile(@NotNull FileViewProvider viewProvider) {
        return new GillesFile(viewProvider);
    }
}
